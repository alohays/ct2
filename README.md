...
| `ct2-lesson add\|retire\|digest` | Cross-ticket operational memory: capture lessons, auto-corroborate on recurrence, render the consult digest (`spec/lessons.md`) |
...
| `ct2-codex-goal ...` | **Deprecated** Codex render over `ct2-goal`; mirrors codex goals into the neutral `.ct2/goals/` record. Prefer `ct2-goal` |
